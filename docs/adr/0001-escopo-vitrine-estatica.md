...
conversão de venda acontece fora do site, via WhatsApp/Instagram (ver
[ADR-0004](0004-conversao-via-contato-externo.md)).
...
- Se o volume de peças ou pedidos crescer a ponto de o processo manual via
  WhatsApp não escalar, esta decisão deve ser revisitada.

## Alternativas consideradas

- **Catálogo + carrinho sem pagamento** (monta pedido, envia por WhatsApp
  formatado): mais complexidade de estado no front-end sem ganho real, já que
  o fechamento ainda é manual.
